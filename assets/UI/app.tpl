				...
				<div class='col-lg-3 col-md-3 py-1' id='face_"+data[key].faceid.S+"'>\
					<div class='card mb-3 shadow-sm'>\
						<div class='bd-placeholder-img card-img-top' width='100%' height='225'>\
							<img src='https://"+cf_url+"/"+data[key].s3key.S+"' name='"+data[key].s3key.S+"' id='img_"+data[key].faceid.S+"' />\
						</div>\
						<div class='card-body'>\
							...
							<div class='d-flex justify-content-between align-items-center'>\
								...
								<small class='text-muted'><a href='https://"+cf_url+"/"+data[key].s3key.S+"' target='_blank' style='color:#777;'><i class='fas fa-external-link-alt'></i></a></small>\
							</div>\
						</div>\
...
$(document).ready(function(){
	...
	$(document).on("click","i.top-info",function(event) {
		...
		$('#info-uiurl').html("<a href='https://"+cf_url+"'>http://"+cf_url+"</a>");
